...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/collection.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js!./src/scss/collection.scss":
/*!***********************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src??ref--6-2!./node_modules/sass-loader/dist/cjs.js!./src/scss/collection.scss ***!
  \***********************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var _scss_collection_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_collection_scss__WEBPACK_IMPORTED_MODULE_0__);
...
const initForm = _ => {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_3___default()('.cat-click').on('click', ev => {
    ...
    const catId = jquery__WEBPACK_IMPORTED_MODULE_3___default()(ev.currentTarget).data('id');
...
document.querySelector("form").addEventListener("submit", ev => {
  ...
  if (form[1].value.length === 0) {
    jquery__WEBPACK_IMPORTED_MODULE_3___default()('#categories-error').removeClass('d-none');
    valid = false;
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_3___default()('#categories-error').addClass('d-none');
  }

  if (valid) {
    const newCol = repo.createCollection(form); // if(newCol.default === true){
...
class Repository {
  ...
  createCategory(form) {
    ...
    const filing = (f, type) => {
      ...
      const ext = path__WEBPACK_IMPORTED_MODULE_1___default.a.extname(file.name);
      const src = file.path;
      const dest = path__WEBPACK_IMPORTED_MODULE_1___default.a.join(this.settings.icon, `${uuid}-${type}${ext}`);
  ...
  async fetchVideoStatistic(hash) {
    const json = fs_jetpack__WEBPACK_IMPORTED_MODULE_3___default.a.read(path__WEBPACK_IMPORTED_MODULE_1___default.a.join(this.settings.db, 'video.json'), "json");
...
/* harmony import */ var _services_statistic__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../services/statistic */ "./src/services/statistic.js");
...
class PointList {
  ...
  vertices() {
    return this.values().map(p => new _services_statistic__WEBPACK_IMPORTED_MODULE_0__["VertexPoint"](p));
  }
...
var api = __webpack_require__(/*! ../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
            var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!../../node_modules/postcss-loader/src??ref--6-2!../../node_modules/sass-loader/dist/cjs.js!./collection.scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/dist/cjs.js!./src/scss/collection.scss");
...
/*!***********************************!*\
  !*** ./src/services/statistic.js ***!
  \***********************************/
/*! exports provided: Graph, Vertex, VertexPoint, VertexStack, Tarjan, Statistic */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VertexPoint", function() { return VertexPoint; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VertexStack", function() { return VertexStack; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Tarjan", function() { return Tarjan; });
...
function Vertex(name) {
  this.name = name || null;
  this.connections = []; // used in tarjan algorithm
...
VertexPoint.prototype = {
  ...
  match: function (vertex, step = 5) {
    return vertex.point.categoryId === this.point.categoryId && Math.abs(vertex.point.currentTime - this.point.currentTime) <= step;
  }
};
...
Tarjan.prototype = {
  ...
  strongconnect: function (vertex) {
    ...
    this.stack.vertices.push(vertex); // Consider successors of v
    ...
    if (vertex.lowlink == vertex.index) {
      ...
      if (this.stack.vertices.length > 0) {
        do {
          w = this.stack.vertices.pop(); // add w to current strongly connected component
