...
/* harmony import */ var _entity_Video__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./entity/Video */ "./src/model/entity/Video.js");
...
class Repository {
  ...
  fetchVideo() {
    return [new _entity_Video__WEBPACK_IMPORTED_MODULE_3__["Video"](), new _entity_Video__WEBPACK_IMPORTED_MODULE_3__["Video"]()];
  }
...
class Video {
  constructor() {
    ...
    this.name = "video 1";
    this.duration = 123;
    this.collection = new _Collection__WEBPACK_IMPORTED_MODULE_0__["Collection"]();
    this.total = 134;
    this.createdAt = moment__WEBPACK_IMPORTED_MODULE_1___default()();
    this.last = 111;
  }
