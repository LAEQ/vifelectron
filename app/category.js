...
repository.fetchCategory().then(result => {
  ...
  table = jquery__WEBPACK_IMPORTED_MODULE_3___default()('#table').DataTable({
    ...
    "columnDefs": [{
      ...
      "targets": -1,
      "data": null,
      "defaultContent": "<button class='btn btn-sm btn-outline-primary edit'>Edit</button>"
    }]
  });
  jquery__WEBPACK_IMPORTED_MODULE_3___default()('#table tbody').on('click', 'button', function () {
    ...
    if (jquery__WEBPACK_IMPORTED_MODULE_3___default()(this).hasClass('delete')) {
      ...
      if (response === 1) {
        ...
        fs_jetpack__WEBPACK_IMPORTED_MODULE_2___default.a.removeAsync(data.pathDefault);
        fs_jetpack__WEBPACK_IMPORTED_MODULE_2___default.a.removeAsync(data.pathPrimary);
        fs_jetpack__WEBPACK_IMPORTED_MODULE_2___default.a.removeAsync(data.pathDanger);
      }
    } else {
      setFormData(data);
    }
