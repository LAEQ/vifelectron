...
const appDir = fs_jetpack__WEBPACK_IMPORTED_MODULE_1___default.a.cwd(app.getAppPath()); // Holy crap! This is browser window with HTML and stuff, but I can read
...
document.querySelector("form").addEventListener("submit", _ => {
  ...
  if (file) {
    electron__WEBPACK_IMPORTED_MODULE_0__["ipcRenderer"].send("category:create", file.path);
  }
});
